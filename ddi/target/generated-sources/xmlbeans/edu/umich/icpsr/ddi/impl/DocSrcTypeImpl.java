 ...
 */
public class DocSrcTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements edu.umich.icpsr.ddi.DocSrcType
{
    private static final long serialVersionUID = 1L;
    
    public DocSrcTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public edu.umich.icpsr.ddi.DocSrcType.Source.Enum getSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (edu.umich.icpsr.ddi.DocSrcType.Source.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public edu.umich.icpsr.ddi.DocSrcType.Source xgetSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.umich.icpsr.ddi.DocSrcType.Source target = null;
            target = (edu.umich.icpsr.ddi.DocSrcType.Source)get_store().find_attribute_user(SOURCE$24);
            if (target == null)
            {
                target = (edu.umich.icpsr.ddi.DocSrcType.Source)get_default_attribute_value(SOURCE$24);
            }
            return target;
        }
    }
     ...
     */
    public void setSource(edu.umich.icpsr.ddi.DocSrcType.Source.Enum source)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetSource(edu.umich.icpsr.ddi.DocSrcType.Source source)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (edu.umich.icpsr.ddi.DocSrcType.Source)get_store().add_attribute_user(SOURCE$24);
            }
            target.set(source);
        }
    }
     ...
     */
    public static class SourceImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements edu.umich.icpsr.ddi.DocSrcType.Source
    {
        private static final long serialVersionUID = 1L;
