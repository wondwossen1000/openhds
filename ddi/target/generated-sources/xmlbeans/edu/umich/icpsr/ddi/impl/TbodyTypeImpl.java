 ...
 */
public class TbodyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements edu.umich.icpsr.ddi.TbodyType
{
    private static final long serialVersionUID = 1L;
    
    public TbodyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public edu.umich.icpsr.ddi.TbodyType.Valign.Enum getValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (edu.umich.icpsr.ddi.TbodyType.Valign.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public edu.umich.icpsr.ddi.TbodyType.Valign xgetValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.umich.icpsr.ddi.TbodyType.Valign target = null;
            target = (edu.umich.icpsr.ddi.TbodyType.Valign)get_store().find_attribute_user(VALIGN$2);
            return target;
        }
    }
     ...
     */
    public void setValign(edu.umich.icpsr.ddi.TbodyType.Valign.Enum valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetValign(edu.umich.icpsr.ddi.TbodyType.Valign valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (edu.umich.icpsr.ddi.TbodyType.Valign)get_store().add_attribute_user(VALIGN$2);
            }
            target.set(valign);
        }
    }
     ...
     */
    public static class ValignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements edu.umich.icpsr.ddi.TbodyType.Valign
    {
        private static final long serialVersionUID = 1L;
