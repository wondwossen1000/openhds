 ...
 */
public class OthRefsTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements edu.umich.icpsr.ddi.OthRefsType
{
    private static final long serialVersionUID = 1L;
    
    public OthRefsTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public edu.umich.icpsr.ddi.OthRefsType.Source.Enum getSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (edu.umich.icpsr.ddi.OthRefsType.Source.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public edu.umich.icpsr.ddi.OthRefsType.Source xgetSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.umich.icpsr.ddi.OthRefsType.Source target = null;
            target = (edu.umich.icpsr.ddi.OthRefsType.Source)get_store().find_attribute_user(SOURCE$24);
            if (target == null)
            {
                target = (edu.umich.icpsr.ddi.OthRefsType.Source)get_default_attribute_value(SOURCE$24);
            }
            return target;
        }
    }
     ...
     */
    public void setSource(edu.umich.icpsr.ddi.OthRefsType.Source.Enum source)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetSource(edu.umich.icpsr.ddi.OthRefsType.Source source)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (edu.umich.icpsr.ddi.OthRefsType.Source)get_store().add_attribute_user(SOURCE$24);
            }
            target.set(source);
        }
    }
     ...
     */
    public static class SourceImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements edu.umich.icpsr.ddi.OthRefsType.Source
    {
        private static final long serialVersionUID = 1L;
