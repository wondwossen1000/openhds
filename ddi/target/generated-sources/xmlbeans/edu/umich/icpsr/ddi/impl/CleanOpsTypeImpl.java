 ...
 */
public class CleanOpsTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements edu.umich.icpsr.ddi.CleanOpsType
{
    private static final long serialVersionUID = 1L;
    
    public CleanOpsTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public edu.umich.icpsr.ddi.CleanOpsType.Source.Enum getSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (edu.umich.icpsr.ddi.CleanOpsType.Source.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public edu.umich.icpsr.ddi.CleanOpsType.Source xgetSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.umich.icpsr.ddi.CleanOpsType.Source target = null;
            target = (edu.umich.icpsr.ddi.CleanOpsType.Source)get_store().find_attribute_user(SOURCE$22);
            if (target == null)
            {
                target = (edu.umich.icpsr.ddi.CleanOpsType.Source)get_default_attribute_value(SOURCE$22);
            }
            return target;
        }
    }
     ...
     */
    public void setSource(edu.umich.icpsr.ddi.CleanOpsType.Source.Enum source)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetSource(edu.umich.icpsr.ddi.CleanOpsType.Source source)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (edu.umich.icpsr.ddi.CleanOpsType.Source)get_store().add_attribute_user(SOURCE$22);
            }
            target.set(source);
        }
    }
     ...
     */
    public static class SourceImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements edu.umich.icpsr.ddi.CleanOpsType.Source
    {
        private static final long serialVersionUID = 1L;
