 ...
 */
public class GeogCoverTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements edu.umich.icpsr.ddi.GeogCoverType
{
    private static final long serialVersionUID = 1L;
    
    public GeogCoverTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public edu.umich.icpsr.ddi.GeogCoverType.Source.Enum getSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (edu.umich.icpsr.ddi.GeogCoverType.Source.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public edu.umich.icpsr.ddi.GeogCoverType.Source xgetSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.umich.icpsr.ddi.GeogCoverType.Source target = null;
            target = (edu.umich.icpsr.ddi.GeogCoverType.Source)get_store().find_attribute_user(SOURCE$26);
            if (target == null)
            {
                target = (edu.umich.icpsr.ddi.GeogCoverType.Source)get_default_attribute_value(SOURCE$26);
            }
            return target;
        }
    }
     ...
     */
    public void setSource(edu.umich.icpsr.ddi.GeogCoverType.Source.Enum source)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetSource(edu.umich.icpsr.ddi.GeogCoverType.Source source)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (edu.umich.icpsr.ddi.GeogCoverType.Source)get_store().add_attribute_user(SOURCE$26);
            }
            target.set(source);
        }
    }
     ...
     */
    public static class SourceImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements edu.umich.icpsr.ddi.GeogCoverType.Source
    {
        private static final long serialVersionUID = 1L;
